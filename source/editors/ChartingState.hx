...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Start Song Pos','Event by 4Axion\nStarts song at the event'],
		...
		['Toggle Swing', "Turn the 'Swing' mode on or off \nValue 1: False = 0, True = 1."],
		['Change Crowd Idle', "Change the crowd idle for the Voltz Stages.\n(I couldn't be fucked to hardcode this shit).\nValue 1: What animation to play"],
		['God Voltz', "Does an tween and makes the ki visible on God Voltz,\n only to be used during the transformation in Homestretch."]
	];
