...
class Alphabet extends FlxSpriteGroup
{
	...
	public var multStair:Bool = false;
	public var startImm:Bool = false;
	public var targetY:Float = 0;
	public var yMult:Float = 120;
	public var liveOfs:Float = 0;
	...
	function doMenuitemXShit()
		{
			...
			if(forceX != Math.NEGATIVE_INFINITY) {
				...
				if (!multStair)
					...
					x = FlxMath.lerp(x, ((targetY * 20) + 90 + xAdd)*-1+liveOfs, lerpVal);
			}
		}
