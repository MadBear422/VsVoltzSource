...
class WeekData {
	...
	public static function reloadWeekFiles(isStoryMode:Null<Bool> = false, char:String = null)
	{
		weeksList = [];
		weeksLoaded.clear();
		/*
		...
		*/
		...
		var sexList:Array<String> = CoolUtil.coolTextFile(Paths.getPreloadPath('weeks/weekList' + listVer + '.txt'));
