...
IntroTagColor = 'e5e5e5'	--Color of the tag at the end of the box.
...
-- 	if tick == 1 then
-- 		local f = assert(io.open('assets/data/'..songName..'/credit.txt', "r")) -- rad
-- 		local t = f:read("*all")
-- 		f:close()
-- 		makeLuaText('JukeBoxSubText2', ''..t, 300, -305-IntroTagWidth, 90)
