function onCreatePost()
	...
	addAnimationByPrefix('fakeVoltz', 'shock', 'Voltz electroshock glasses0', 24, false)
	addAnimationByPrefix('fakeVoltz', 'shockS', 'Voltz electroshock glasses safe0', 24, false)
	setProperty('fakeVoltz.visible', false)
	addLuaSprite('fakeVoltz', true)	
	
	setPropertyFromClass('GameOverSubstate', 'characterName', 'VoltzButDead-Car')
...
function onGameOver() -- Fix BF being off center on Death
	...
	setCharacterX('boyfriend', getCharacterX('boyfriend') - 45)
