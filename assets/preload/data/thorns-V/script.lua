...
-- 		doReturn = false;
-- 		startSenpaiCutscene('thorns', 'thorns');
-- 		playMusic('LunchboxScary', 1)
-- 		doReturn = true;
...
-- 	curCharacterPlaysMusic = dialoguePlaysMusic[curDialogue];
...
-- 		setSoundVolume('', 1)
-- 	end
-- 	if curCharacterPlaysMusic then
-- 		playMusic('LunchboxScary', 1)
-- 	end
...
-- 		setProperty('fakeN1.offset.y', -72)
